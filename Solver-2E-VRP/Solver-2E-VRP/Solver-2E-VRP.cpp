...
void buildTestSolution(Solution &s, Problem *p) {
    ...
    e1.sequence.push_back(p->getSatellite(0));
    s.getE1Routes().push_back(e1);
    e1.cost = 44.18144226074219;
    e1.load = 11500;
    e1.departure = p->getDepot();
    e1.sequence.clear();
    e1.sequence.push_back(p->getSatellite(1));
    s.getE1Routes().push_back(e1);
    ...
    e2.sequence.push_back(p->getClient(8));
    e2.sequence.push_back(p->getClient(6));
    e2.sequence.push_back(p->getClient(4));
    e2.sequence.push_back(p->getClient(1));
    e2.sequence.push_back(p->getClient(0));
    e2.sequence.push_back(p->getClient(5));
    s.getE2Routes().push_back(e2);
    e2.cost = 102.20066428184509;
    e2.load = 5400;
    e2.departure = p->getSatellite(0);
    e2.sequence.clear();
    e2.sequence.push_back(p->getClient(7)); // 10,12,15,13,6,5
    e2.sequence.push_back(p->getClient(9));
    e2.sequence.push_back(p->getClient(12));
    e2.sequence.push_back(p->getClient(10));
    e2.sequence.push_back(p->getClient(3));
    e2.sequence.push_back(p->getClient(2));
    s.getE2Routes().push_back(e2);
    e2.cost = 58.23817253112793;
    e2.load = 6000;
    e2.departure = p->getSatellite(1); //21,23,22,19
    e2.sequence.clear();
    e2.sequence.push_back(p->getClient(18));
    e2.sequence.push_back(p->getClient(20));
    e2.sequence.push_back(p->getClient(19));
    e2.sequence.push_back(p->getClient(16));
    s.getE2Routes().push_back(e2);
    e2.cost = 77.1982045173645;
    e2.load = 5500;
    e2.departure = p->getSatellite(1); // 18,16,14,17,20
    e2.sequence.clear();
    e2.sequence.push_back(p->getClient(15));
    e2.sequence.push_back(p->getClient(13));
    e2.sequence.push_back(p->getClient(11));
    e2.sequence.push_back(p->getClient(14));
    e2.sequence.push_back(p->getClient(17));
    s.getE2Routes().push_back(e2);
